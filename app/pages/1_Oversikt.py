"""
Oversikt – Hovedtall for punktlighet på togstrekninger i Norge
──────────────────────────────────────────────────────────────
Nasjonale KPI-kort, Plotly interaktive grafer, tidsheatmap (time × ukedag)
med Viridis-fargeskala, uteliggerdeteksjon og trendindikator.
Data fra Entur (NLOD 2.0).
"""
...
st.title("Hovedtall for punktlighet på togstrekninger i Norge")
st.markdown(
...
st.caption(
    "Data publisert under [NLOD 2.0](https://data.norge.no/nlod/no/2.0). "
    "Uoffisielt prosjekt uten tilknytning til Entur, Bane NOR eller togselskapene — "
    "tallene kan inneholde feil eller mangler. Entur påtar seg intet ansvar for "
    "konsekvenser av feil i data eller API-systemene."
)
